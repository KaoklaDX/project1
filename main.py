...
class Show_foodScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.scroll_view = ScrollView(size_hint=(1, None), size=(Window.width, Window.height - self.label.height - 50))
    ...
    def refresh_display(self):
        ...
        scroll_height = len(self.food_items) * dp(80)  # Assuming each label is 50dp in height
        self.scroll_view.height = min(scroll_height, Window.height - self.label.height - dp(10))
